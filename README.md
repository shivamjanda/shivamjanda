...
🧑‍🎓 Studying [Computer Programming and Analysis] at Durham College and then transferring to Ontario Tech University for my [Computer Science] degree<br/>
...
#Languages and frameworks I have experience in from school and or personal use : 
JavaScript, Python, C#, Java, C++, AJAX, WPF, XAML, ASP.NET Core, jQuery, .NET framwork, Node.js, Express.js, React.js, REST API's, COBOL, VITE, Three.js
