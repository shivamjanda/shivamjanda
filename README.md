...
JavaScript, Python, C#, Java, C++, AJAX, WPF, XAML, jQuery, React.js, REST API's, COBOL, VITE, Three.js, PHP<br/>  

Backend:  Django, Node.js, Express.js, ASP .Net core, .Net Framework, 

Database: SQL(MySQL), PostgreSQL, NoSQL, SQLLite, MongoDB<br/> 

Other: HTML/CSS, Tailwind css, PHP, Git, Unit Test framework, Selenium IDE/ Web Driver, Unix terminal, Shell Scripting<br/> 
